...
public class OcinkaKodu4 extends JFrame {
	...
	public OcinkaKodu4 (int grup_putanna,int grup_putanna1, int grup_putanna2, int grup_putanna3, int grup_putanna4,
		...
		l_Stat = new JLabel("Можливо унікально відстежувати дії користувача ?");
		...
		l_RikNarodgenna = new JLabel("Неможливо відхилити дії, події для яких доведено існування ?");
		...
		l_Zrist = new JLabel("Доведено ідентичность суб'єкта, ресурсу заявленому об'єкту ?");
		...
		l_Vaga = new JLabel("Складається з частин, що легко замінюються без впливу ?");
		...
		l_Profesia = new JLabel("Основа (актив) ПЗ може бути побудована з іншого ПЗ ?");
...
//				grup_putanna20 + " " + grup_putanna21 + " " + grup_putanna22 + " " + grup_putanna23 + " " + grup_putanna24);
		if (grup_putanna20 != 0 && grup_putanna21 != 0 && grup_putanna22 != 0 && grup_putanna23 != 0 && grup_putanna24 != 0) {
			new OcinkaKodu5(grup_putanna, grup_putanna1, grup_putanna2, grup_putanna3, grup_putanna4,
