...
public class OcinkaKodu2 extends JFrame {
	...
	public OcinkaKodu2 (int grup_putanna,int grup_putanna1, int grup_putanna2, int grup_putanna3, int grup_putanna4,
		...
		l_Stat = new JLabel("Можна використовувати з найширшим діапазоном якостей ?");
		...
		l_RikNarodgenna = new JLabel("ПЗ має естетичності інтерфейсу користувача ?");
		...
		l_Zrist = new JLabel("Ступінь задоволення потреб у надійності ?");
		...
		l_Vaga = new JLabel("Функціонування та доступність ПЗ, коли воно потрібне ?");
		...
		l_Profesia = new JLabel("Працюватиме незалежно від апаратних чи програмних збоїв ?");
...
//				grup_putanna10 + " " + grup_putanna11 + " " + grup_putanna12 + " " + grup_putanna13 + " " + grup_putanna14);
		if (grup_putanna10 != 0 && grup_putanna11 != 0 && grup_putanna12 != 0 && grup_putanna13 != 0 && grup_putanna14 != 0) {
			new OcinkaKodu3(grup_putanna, grup_putanna1, grup_putanna2, grup_putanna3, grup_putanna4,
