...
public class OcinkaKodu extends JFrame {
	...
	public OcinkaKodu() {
		...
		l_Stat = new JLabel("ПЗ забезпечує результат з необхідним ступенем точності ?");
		...
		l_RikNarodgenna = new JLabel("Система покриває усі визначені завдання та цілі ?");
		...
		l_Zrist = new JLabel("ПЗ сприяє досягненню визначених цілей та завдань ?");
		...
		l_Vaga = new JLabel("Відповідає результатам, часу обробки і пропускної здатност ?");
		...
		l_Profesia = new JLabel("Відповідає вимогам ресурсів, використаних в ПЗ ?");
...
//		l_fon.setIcon(new ImageIcon("C:\\Users\\ZakkZakk\\Desktop\\Oputuvanna.PNG"));
	...
	void dali() {
//		System.out.println(
//				grup_putanna + " " + grup_putanna1 + " " + grup_putanna2 + " " + grup_putanna3 + " " + grup_putanna4);
		if (grup_putanna != 0 && grup_putanna1 != 0 && grup_putanna2 != 0 && grup_putanna3 != 0 && grup_putanna4 != 0) {
			new OcinkaKodu1(grup_putanna, grup_putanna1, grup_putanna2, grup_putanna3, grup_putanna4);
			setVisible(false);
		}
	}
